        ...
        if op.type == 26:
            try:
              ...
              ## LURKING ##                      
                                ...
                                puy.sendMessage(to, contentMetadata={'countryCode': 'ID', 'i-installUrl': 'line://ti/p/~yapuy', 'a-packageName': 'com.spotify.music', 'linkUri': 'line://ti/p/~yapuy', 'subText': '??', 'a-installUrl': 'line://ti/p/~yapuy', 'type': 'mt', 'previewUrl': image, 'a-linkUri': 'line://ti/p/~yapuy', 'id': 'mt000000000a6b79f9', 'i-linkUri': 'line://ti/p/~yapuy'}, contentType=19)
                                #'text': 'apaasu',
                           ...
                           #else:
                           #    sendMention(to, 'Failed GetResult Token!')
                                
                            if text.lower() == '#login iospad':
                                req = requests.get('https://api.eaterbots.com/IOSPAD')
                                a = req.text
                                b = json.loads(a)
                                tknop= codecs.open("tkn.json","r","utf-8")
                                tkn = json.load(tknop)
